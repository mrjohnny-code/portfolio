		...
		<section className="portfolio" ref={portfolioTopRef}>
			<div className="container">
				...
				<div className="portfolio__about">
					...
					<p className="portfolio__description note">В настоящее время изучаю React (hooks, state, components, базовый routing). <br/> Данное портфолио реализовано на React, при разработке использовались AI-инструменты для ускорения работы и поиска оптимальных решений.</p>
				</div>
